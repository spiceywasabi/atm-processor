...
selected_packages+="screen python-light python-logging python-multiprocessing python-pyserial nano lsof logd kmod-gpio-button-hotplug e2fsprogs htop kmod-sdhci kmod-mt76-core kmod-mt76-usb htop serialconsole setserial "
